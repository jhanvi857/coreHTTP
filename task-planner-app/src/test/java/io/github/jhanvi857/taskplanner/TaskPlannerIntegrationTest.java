...
public class TaskPlannerIntegrationTest {
    ...
    private static NioFlowApp buildTestApp() {
        ...
        testApp.use(new io.github.jhanvi857.nioflow.middleware.LoggerMiddleware());
        testApp.use(new io.github.jhanvi857.nioflow.middleware.MetricsMiddleware());
        testApp.use(new io.github.jhanvi857.nioflow.middleware.CorsMiddleware("http://localhost:3000"));
        testApp.use(new io.github.jhanvi857.nioflow.middleware.RateLimitMiddleware(1000, 10_000));

        testApp.register(new io.github.jhanvi857.nioflow.plugin.HealthCheckPlugin());
        ...
        testApp.get("/metrics", ctx ->
            ctx.status(HttpStatus.OK).send(
                io.github.jhanvi857.nioflow.middleware.MetricsMiddleware.getMetricsReport())
        );
