...
import com.jhanvi857.nioflow.protocol.HttpResponse;
...
public class HttpServer {
    ...
    private void acceptNewClient(ServerSocketChannel serverChannel, com.jhanvi857.nioflow.routing.Router router)
            throws IOException {
