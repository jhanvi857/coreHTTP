          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 w-full flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 flex flex-col items-start text-left">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold tracking-tight text-white leading-tight mb-6">
                A High-Performance HTTP Server <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-600">Built from Scratch.</span>
              </h1>

              <p className="text-lg text-gray-400 mb-10 leading-relaxed max-w-xl">
                Ditch the abstractions of Tomcat and Spring Boot. coreHTTP is a fully functional web server demonstrating the raw mechanics of non-blocking I/O, custom request parsing, and middleware chaining.
              </p>
              ...
              <div className="rounded-xl border border-[#333] bg-[#0e0e11] overflow-hidden shadow-2xl relative">
                <div className="flex items-center px-4 py-3 border-b border-[#222] bg-[#1a1a1e] relative">
                  ...
                  <div className="w-full text-center">
                    <span className="text-xs font-mono text-gray-400">core_http_server — bash</span>
                  </div>
                </div>
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="mb-20 max-w-3xl">
              ...
              <p className="text-gray-400 text-lg md:text-xl leading-relaxed">
                By writing the transport and protocol layers from the ground up, this repository illustrates fundamental design patterns typically hidden by massive enterprise frameworks.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="p-10 rounded-2xl border border-[#222] bg-[#111] hover:bg-[#151515] transition-colors group">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white">Multiplexed Event Loop</h3>
                <p className="text-gray-400 leading-relaxed text-[16px]">
                  Built entirely on Java's <code className="text-gray-300 bg-[#222] px-1.5 py-0.5 rounded text-sm">java.nio</code> module. A single worker thread multiplexes thousands of concurrent connections using a Selector, completely bypassing the heavy OS-level context switching of thread-per-connection architectures.
                </p>
              </div>
          ...
          <div className="max-w-[1200px] mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-lg text-gray-400 mb-10 leading-relaxed text-balance">
                This project isn't just a server; it's a dissectible case study in protocol design and network programming compiled into a lightweight executable. Expand your engineering fundamentals.
              </p>
